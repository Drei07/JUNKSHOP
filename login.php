      ...
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10">
          <div class="wrap d-md-flex">
            <div class="img" style=" background-image:url('<?= validate_image($_settings->info('cover')) ?>');">
            </div>
            <div class="login-wrap p-4 p-md-5">
              ...
              <form action="" method="POST" id="clogin-frm">
              ...
              <p class="text-center">Not a member? <a data-toggle="" href="<?php echo base_url.'register.php' ?>">Create an Account</a></p>
            </div>
          </div>
        </div>
      </div>
