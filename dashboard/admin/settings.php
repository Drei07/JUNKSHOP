				...
				<div class="app-header-content">
					<div class="row justify-content-between align-items-center">
						...
						<div class="app-utilities col-auto">
							...
							<a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="../../src/img/<?php echo $profile_admin ?>" alt="user profile"></a>
		    ...
		    <div class="container-xl">			    
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Settings section intro goes here. Lorem ipsum dolor sit amet, consectetur adipiscing elit. <a href="help">Learn more</a></div>
	                </div>
